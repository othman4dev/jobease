                ...
                <table class="agent table align-middle bg-white" style="min-width: 700px;">
                    ...
                    <tbody>
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            ...
                            <td class=''>
                                <a href='edit.php?id=".$row['id']."'><button class='btn btn-success edit' data-id='".$row['id']."'>Edit</button></a>
                                <a href='delete.php?id=".$row['id']."'><button class='btn btn-danger delete' data-id='".$row['id']."'>Delete</button></a>
                            </td>
                        </tr>
                            ";
                        }
